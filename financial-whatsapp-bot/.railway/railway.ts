...
export default defineRailway(() => {
  ...
  const incredibleAdventure = service("incredible-adventure", {
    ...
    env: {
      ...
      INGESTION_EMBEDDING_BATCH_SIZE: financialWhatsappBot.env.INGESTION_EMBEDDING_BATCH_SIZE,
      INGESTION_ENABLE_CONTEXTUAL: financialWhatsappBot.env.INGESTION_ENABLE_CONTEXTUAL,
      INGESTION_JOB_TIMEOUT_SECONDS: financialWhatsappBot.env.INGESTION_JOB_TIMEOUT_SECONDS,
      INGESTION_MAX_UPLOAD_MB: financialWhatsappBot.env.INGESTION_MAX_UPLOAD_MB,
      INGESTION_STORAGE_BUCKET: financialWhatsappBot.env.INGESTION_STORAGE_BUCKET,
